...
public class Project {
	...
	public ArrayList<Person> insertPersons(Connection connection) throws Exception {
		ArrayList<Person> personData = new ArrayList<Person>();
		try {
			// String uname = request.getParameter("uname");
			PreparedStatement ps = connection.prepareStatement("insert id,tckn,name,lastname,adress FROM person");
			// insert into users_db.person (tckn,name,lastname,adress)
			// values('01515151515','Gulsum','Ekim','kadikoy/istanbul');
